...
from talkylabs.reach.base import deserialize
...
class Iso8601DateTimeTestCase(unittest.TestCase):
    ...
    def test_parsableBis(self):
        actual = deserialize.iso8601_datetime("2015-01-02T03:04:05.001Z")
        expected = datetime.datetime(2015, 1, 2, 3, 4, 5, 1000, pytz.utc)
        self.assertEqual(expected, actual)
