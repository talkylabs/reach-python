# Contributing to `reach-python`

We'd love for you to contribute to our source code and to make `reach-python`
...
Help us keep `reach-python` open and inclusive. Please be kind to and considerate
of other developers, as we all have the same goal: make `reach-python` as good as
it can be.

## <a name="question"></a> Got an API/Product Question or Problem?

If you have questions about how to use `reach-python`, please see our
...
* **Major Changes** that you wish to contribute to the project should be
  discussed first with `reach-python` contributors in an issue or pull request so
...
* **`reach-python` Version(s)** - is it a regression?
...
* Run the full `reach-python` test suite (aliased by `make test`), and ensure
  that all tests pass.
...
In GitHub, send a pull request to `reach-python:main`.
If we suggest changes, then:

* Make the required updates.
* Re-run the `reach-python` test suite to ensure tests are still passing.
...
[issue-link]: https://github.com/talkylabs/reach-python/issues/new
[github]: https://github.com/talkylabs/reach-python