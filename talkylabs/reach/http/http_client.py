...
_logger = logging.getLogger("talkylabs.reach.http.http_client")


class ReachHttpClient(HttpClient):
    """
    General purpose HTTP Client for interacting with the Reach API
    """
    ...
    def __init__(
        ...
        """
        Constructor for the ReachHttpClient
