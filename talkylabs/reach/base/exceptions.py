...
class ReachRestException(ReachException):
    """A generic 400 or 500 level exception from the Reach API
    ...
    :param int|None code: A Reach API specific error code for the error. This is
    ...
    def __str__(self) -> str:
        ...
        def get_code_info(code: int) -> str:
            return "The code of the received error is {0}".format(code)
        ...
        if hasattr(sys.stderr, "isatty") and sys.stderr.isatty():
            msg = (
                ...
                "\n\n{reach_returned}\n\n{message}\n".format(
                    ...
                    reach_returned=white("Reach returned the following information:"),
            ...
            if self.code:
                msg = "".join(
                    [
                        msg,
                        "\n{more_info}\n\n{uri}\n\n".format(
                            more_info=white("More information:"),
                            uri=blue(get_code_info(self.code)),
                        ),
                    ]
                )
            return msg
