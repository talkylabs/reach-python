...
def iso8601_date(d):
    """
    Return a string representation of a date that the Reach API understands
...
def json_serial(obj):
    ...
    if isinstance(obj, (datetime.datetime)):
        return iso8601_datetime(obj)
    elif isinstance(obj, (datetime.date)):
        return iso8601_date(obj)
    else:
        return str(obj)
...
def serialize(obj):
    ...
    """
    if isinstance(obj, dict) or isinstance(obj, list):
        return json.dumps(obj, default=json_serial, indent=1)
    return obj
