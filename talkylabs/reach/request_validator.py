...
def remove_port(uri):
    ...
    :param uri: parsed URI that Reach requested on your server
...
class RequestValidator(object):
    ...
    def compute_signature(self, uri, params):
        ...
        :param uri: full URI that Reach requested on your server
        :param params: post vars that Reach sent with the request
    ...
    def validate(self, uri, params, signature):
        """Validate a request from Reach

        :param uri: full URI that Reach requested on your server
        :param params: dictionary of POST variables or string of POST body for JSON requests
        :param signature: expected signature in HTTP X-Reach-Signature header
